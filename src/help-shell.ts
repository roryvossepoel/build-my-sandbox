...
function ensureConfigActions() {
  ...
  wrapper.innerHTML = `
    ...
    <div class="wsb-config-actions-buttons">
      <button type="button" data-card-import>
        <span class="wsb-config-action-icon" aria-hidden="true"></span>
        <span class="wsb-config-action-copy"><strong>Import</strong><small>Load saved setup</small></span>
      </button>
      <button type="button" data-card-export>
        <span class="wsb-config-action-icon" aria-hidden="true"></span>
        <span class="wsb-config-action-copy"><strong>Export</strong><small>Save setup</small></span>
      </button>
    </div>
  `;
